...
import { AcquireLocationsPie } from '../../../components/charts/AcquireLocationsPie';
            ...
            <View>
                <HeaderPage title="Team 100" bkg={Colors.TeamSelectColor.color}>
                    ...
                    <View style={[globalStyles.pageCenter]}>
                        ...
                        <Br />
                        <BigStat stat="66%" comment="high shoot success" />
                    </View>
                    <Br />
                    <Br />
                    <View>
                        <Text style={[globalStyles.h2]}>Field Locations</Text>
                        <Text style={[globalStyles.h3]}>Scoring Locations</Text>
                        <LocationsPie />
                        <Text style={[globalStyles.h3]}>Acquire Locations</Text>
